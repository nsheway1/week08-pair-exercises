...
### Non-MVP Use Cases
Once you have completed all of the required use cases, complete as many of the following non-MVP use cases as you can.
...
In the database folder, you'll find the database creation scripts and a shell script called `create.sh`. Run `winpty sh create.sh` from the database folder in Bash to create the database.
...
No starting users are included in the database.  You can create users by using the provided registration functionality.
